...
require (
	...
	github.com/ledgerwatch/erigon-snapshot v1.3.1-0.20240630180403-d58546cfe1e8 // indirect
...
replace (
	github.com/anacrolix/torrent => github.com/erigontech/torrent v1.54.2-alpha-25
