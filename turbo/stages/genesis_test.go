...
func TestSetupGenesis(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			blockReader := freezeblocks.NewBlockReader(freezeblocks.NewRoSnapshots(ethconfig.BlocksFreezing{}, dirs.Snap, 0, log.New()), freezeblocks.NewBorRoSnapshots(ethconfig.BlocksFreezing{}, dirs.Snap, 0, log.New()), freezeblocks.NewBscRoSnapshots(ethconfig.BlocksFreezing{}, dirs.Snap, 0, log.New()))
